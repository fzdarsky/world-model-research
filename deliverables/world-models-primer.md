...
**Funding signals indicate enterprise confidence:** AMI Labs raised $1.03B (JEPA commercialization), World Labs $1B (3D world generation), Periodic Labs $300M (materials discovery), Genesis AI $105M (full-stack dexterous robotics). These are not science experiments — investors are betting on near-term revenue from world model deployments in robotics, autonomous vehicles, drug discovery, and industrial automation. The question is no longer "will world models work?" but "which approaches scale fastest and where?"
